...
DOCUMENTATION = """
module: vcenter_vm_hardware_floppy_connect
short_description: Handle resource of type vcenter_vm_hardware_floppy_connect
description: Handle resource of type vcenter_vm_hardware_floppy_connect
options:
  floppy:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["floppy"] = {"type": "str", "operationIds": ["connect"]}
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/floppy/{floppy}/connect".format(
        **params
    )
