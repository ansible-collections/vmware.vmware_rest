...
short_description: Handle resource of type appliance_networking_interfaces_ipv4
description: Handle resource of type appliance_networking_interfaces_ipv4
options:
  config:
    description:
    - IPv4 Configuration to set for the machine This parameter is mandatory.
...
async def main():
    required_if = list([["state", "set", ["config", "interface_name"], True],])
