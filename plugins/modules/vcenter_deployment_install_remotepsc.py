...
DOCUMENTATION = """
module: vcenter_deployment_install_remotepsc
short_description: Handle resource of type vcenter_deployment_install_remotepsc
description: Handle resource of type vcenter_deployment_install_remotepsc
options:
  action:
    choices:
    - check
...
def prepare_argument_spec():
    ...
    argument_spec["psc_hostname"] = {"type": "str", "operationIds": ["check"]}
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/vcenter/deployment/install/remote-psc".format(
        **params
    )
...
async def _check(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{vcenter_hostname}/rest/vcenter/deployment/install/remote-psc".format(
        **params
    )
