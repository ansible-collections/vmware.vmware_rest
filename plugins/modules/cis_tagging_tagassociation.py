...
options:
  object_id:
    description:
    - The identifier of the input object. Required with I(state=['attach', 'attach_multiple_tags_to_object',
      'detach', 'detach_multiple_tags_from_object', 'list_attachable_tags', 'list_attached_tags'])
  ...
  object_ids:
    ...
    - The identifiers of the input objects. Required with I(state=['attach_tag_to_multiple_objects',
      'detach_tag_from_multiple_objects', 'list_attached_tags_on_objects'])
    type: list
  state:
    choices:
    - attach
  ...
  tag_id:
    ...
    - The identifier of the input tag. Required with I(state=['attach', 'attach_tag_to_multiple_objects',
      'detach', 'detach_tag_from_multiple_objects', 'list_attached_objects'])
    type: str
  tag_ids:
    description:
  ...
  ~action:
    ...
    description:
    - ~action=attach-tag-to-multiple-objects Required with I(state=['attach_tag_to_multiple_objects',
      'list_attached_tags_on_objects'])
    type: str
author:
- Ansible VMware team
