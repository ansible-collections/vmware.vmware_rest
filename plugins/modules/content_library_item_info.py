...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the list of items of the NFS library
value:
  description: Get the list of items of the NFS library
  returned: On success
  sample:
  - cached: 1
