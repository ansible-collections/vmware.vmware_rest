...
def prepare_argument_spec():
    ...
    argument_spec["library_id"] = {"type": "str", "operationIds": ["list"]}
    argument_spec["library_item_id"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    ...
    if params["library_item_id"]:
        return "https://{vcenter_hostname}/rest/com/vmware/content/library/item/id:{library_item_id}".format(
            **params
        ) + gen_args(
