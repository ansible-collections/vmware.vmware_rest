...
short_description: Handle resource of type appliance_shutdown_info
description: Handle resource of type appliance_shutdown_info
options:
  vcenter_hostname:
    description:
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/shutdown").format(
        **params
