...
short_description: Handle resource of type appliance_system_time_info
description: Handle resource of type appliance_system_time_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/system/time").format(**params)
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/system/time").format(
        **params
