...
short_description: Handle resource of type appliance_ntp
description: Handle resource of type appliance_ntp
options:
  servers:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/ntp").format(**params)
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/rest/appliance/ntp")
    if subdevice_type and not params[subdevice_type]:
        _json = await exists(params, session, build_url(params))
        if _json:
            params[subdevice_type] = _json["id"]
    _url = ("https://{vcenter_hostname}" "/rest/appliance/ntp").format(
        **params
