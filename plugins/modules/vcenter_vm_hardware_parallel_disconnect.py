...
DOCUMENTATION = """
module: vcenter_vm_hardware_parallel_disconnect
short_description: Handle resource of type vcenter_vm_hardware_parallel_disconnect
description: Handle resource of type vcenter_vm_hardware_parallel_disconnect
options:
  port:
    description:
...
def url(params):
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/parallel/{port}/disconnect".format(
        **params
    )
