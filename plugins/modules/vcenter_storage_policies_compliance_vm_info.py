...
PAYLOAD_FORMAT = {
    "list": {
        "query": {"filter.status": "filter.status", "filter.vms": "filter.vms"},
        "body": {},
        "path": {},
    }
}
...
def prepare_argument_spec():
    ...
    argument_spec["filter_status"] = {"type": "list", "elements": "str"}
...
def build_url(params):
    ...
    return (
        "https://{vcenter_hostname}" "/rest/vcenter/storage/policies/compliance/vm"
