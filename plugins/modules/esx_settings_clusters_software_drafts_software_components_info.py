...
DOCUMENTATION = """
module: esx_settings_clusters_software_drafts_software_components_info
...
def prepare_argument_spec():
    ...
    argument_spec["draft"] = {"type": "str", "operationIds": ["get", "list"]}
...
def url(params):
    if params["component"]:
        return "https://{vcenter_hostname}/rest/api/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/components/{component}".format(
            **params
        ) + gen_args(
