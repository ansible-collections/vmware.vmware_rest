...
short_description: Handle resource of type appliance_networking_dns_hostname_info
description: Handle resource of type appliance_networking_dns_hostname_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return (
        "https://{vcenter_hostname}" "/rest/appliance/networking/dns/hostname"
    ).format(**params)
