...
def prepare_argument_spec():
    ...
    argument_spec["category_id"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    ...
    if params["category_id"]:
        return "https://{vcenter_hostname}/rest/com/vmware/cis/tagging/category/id:{category_id}".format(
            **params
        ) + gen_args(
