...
DOCUMENTATION = """
module: vcenter_vm_hardware_floppy_disconnect
short_description: Handle resource of type vcenter_vm_hardware_floppy_disconnect
description: Handle resource of type vcenter_vm_hardware_floppy_disconnect
options:
  floppy:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["floppy"] = {"type": "str", "operationIds": ["disconnect"]}
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/floppy/{floppy}/disconnect".format(
        **params
    )
