...
short_description: Handle resource of type appliance_services_info
description: Handle resource of type appliance_services_info
options:
  service:
    description:
...
async def main():
    required_if = list([["state", "get", ["service"], True],])
...
def build_url(params):
    if params.get("service"):
        ...
        return (
            ("https://{vcenter_hostname}" "/rest/appliance/services/").format(**params)
            + params["service"]
            + gen_args(params, _in_query_parameters)
        )
    _in_query_parameters = PAYLOAD_FORMAT["list"]["query"].keys()
    return ("https://{vcenter_hostname}" "/rest/appliance/services").format(
        **params
    ) + gen_args(params, _in_query_parameters)
