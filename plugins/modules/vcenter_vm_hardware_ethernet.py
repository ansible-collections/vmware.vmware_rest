...
value:
  ...
  sample:
    ...
    backing:
      connection_cookie: 1771650454
      distributed_port: '2'
      distributed_switch_uuid: 50 33 6a 1f ed 2d d4 e5-e0 d5 ed 79 0c 89 c8 21
      network: dvportgroup-1395
      type: DISTRIBUTED_PORTGROUP
    label: Network adapter 1
    mac_address: 00:50:56:b3:30:fa
    mac_type: ASSIGNED
    pci_slot_number: 4
    start_connected: 0
    state: NOT_CONNECTED
