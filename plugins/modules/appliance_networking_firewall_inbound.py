...
short_description: Handle resource of type appliance_networking_firewall_inbound
description: Handle resource of type appliance_networking_firewall_inbound
options:
  rules:
    description:
...
async def main():
    required_if = list([["state", "set", ["rules"], True],])
...
def build_url(params):
    return (
        "https://{vcenter_hostname}" "/rest/appliance/networking/firewall/inbound"
    ).format(**params)
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/rest/appliance/networking/firewall/inbound")
