...
short_description: Gather information about vCenter content libraries.
description:
  - Retrieve information about the content libraries defined in vCenter, including local, subscribed,
    and any other library types.
  - When O(library_id) is provided, return the full details of that single library, such as its name,
    description, type, storage backings, and publish or subscription settings.
  - When O(library_id) is omitted, list every content library available in the Content Library.
...
options:
  library_id:
    description:
      - The identifier of the content library to retrieve detailed information for.
      - When omitted, information about all content libraries is returned.
      - The value must be the identifier (MOID) of an existing content library.
    type: str
    required: false
...
- name: Get information about a single content library
  vmware.vmware_rest.content_library_info:
    library_id: e6d5c7a1-5a52-4a3b-9c1e-8f0b2d3a4b5c
  register: my_library

- name: Display the name of the queried library
  ansible.builtin.debug:
    var: my_library.value.name
"""

RETURN = r"""
id:
  description: The identifier (MOID) of the content library that was queried.
  returned: When only one library, identified by O(library_id), was queried
  sample: e6d5c7a1-5a52-4a3b-9c1e-8f0b2d3a4b5c
  type: str
value:
  description: Detailed information about a single content library.
  returned: When only one library, identified by O(library_id), was queried
  sample:
  ...
  type: dict
info:
  description: A list of detailed information about all content libraries.
...
LIST_ENDPOINT = "/content/library"
ITEM_ENDPOINT = "/content/library/{library_id}"
