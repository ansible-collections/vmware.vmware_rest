...
results:
  ...
  sample:
  - _ansible_item_label:
      creation_time: '2022-06-16T23:18:15.770Z'
      description: automated
      id: dc125dcd-68cc-47dd-b8f3-e2d61e8dd024
      last_modified_time: '2022-06-16T23:18:15.770Z'
      name: my_library_on_datastore
      publish_info:
        authentication_method: NONE
        persist_json_enabled: 0
        publish_url: https://vcenter.test:443/cls/vcsp/lib/dc125dcd-68cc-47dd-b8f3-e2d61e8dd024/lib.json
        published: 1
        user_name: vcsp
      server_guid: b138c531-cd80-43f5-842d-657d9ddc98f8
      storage_backings:
      - datastore_id: datastore-1480
        type: DATASTORE
      type: LOCAL
      version: '2'
    _ansible_no_log: 0
    ...
    invocation:
      module_args:
        ...
        last_sync_time: null
        library_id: dc125dcd-68cc-47dd-b8f3-e2d61e8dd024
        name: null
