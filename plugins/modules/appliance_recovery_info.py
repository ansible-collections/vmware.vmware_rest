...
DOCUMENTATION = r"""
module: appliance_recovery_info
short_description: Handle resource of type appliance_recovery_info
description: Handle resource of type appliance_recovery_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/recovery").format(**params)
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/recovery").format(
        **params
