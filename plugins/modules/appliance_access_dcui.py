...
short_description: Handle resource of type appliance_access_dcui
description: Handle resource of type appliance_access_dcui
options:
  enabled:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/access/dcui").format(**params)
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/rest/appliance/access/dcui")
    if subdevice_type and not params[subdevice_type]:
        _json = await exists(params, session, build_url(params))
        if _json:
            params[subdevice_type] = _json["id"]
    _url = ("https://{vcenter_hostname}" "/rest/appliance/access/dcui").format(
        **params
