...
RETURN = r"""
# content generated by the update_return_section callback# task: Get the information about the new account
id:
  ...
  type: str
value:
  description: Get the information about the new account
  returned: On success
  sample:
    email: '********@vsphere.local'
    enabled: 1
    fullname: Foobar
    has_password: 1
    last_password_change: '2021-05-18T00:00:00.000Z'
