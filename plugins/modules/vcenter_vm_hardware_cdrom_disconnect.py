...
DOCUMENTATION = """
module: vcenter_vm_hardware_cdrom_disconnect
short_description: Handle resource of type vcenter_vm_hardware_cdrom_disconnect
description: Handle resource of type vcenter_vm_hardware_cdrom_disconnect
options:
  cdrom:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["cdrom"] = {"type": "str", "operationIds": ["disconnect"]}
...
def url(params):
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/cdrom/{cdrom}/disconnect".format(
        **params
    )
