...
short_description: Handle resource of type appliance_health_storage_info
description: Handle resource of type appliance_health_storage_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/health/storage").format(
        **params
    )
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/health/storage").format(
        **params
