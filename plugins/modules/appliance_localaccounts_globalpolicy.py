...
RETURN = r"""
# content generated by the update_return_section callback# task: Update the global policy of the local accounts (idempotency)
value:
  description: Update the global policy of the local accounts (idempotency)
  returned: On success
  sample:
    max_days: -1
    min_days: -1
