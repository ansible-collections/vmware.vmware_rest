...
description:
  - Returns the global password policy for vCenter appliance local accounts.
  - The policy includes password age limits, warning periods, and complexity requirements.
author:
...
value:
  description:
    - Global password policy settings for local accounts.
  returned: On success
  type: dict
  sample:
    max_days: 90
