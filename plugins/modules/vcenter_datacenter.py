...
RETURN = """
# content generated by the update_return_section callback# task: Create datacenter my_dc
id:
  description: moid of the resource
  returned: On success
  sample: datacenter-1356
  type: str
value:
  description: Create datacenter my_dc
  returned: On success
  sample:
    datastore_folder: group-s1359
    host_folder: group-h1358
    name: my_dc
    network_folder: group-n1360
    vm_folder: group-v1357
  type: dict
"""
