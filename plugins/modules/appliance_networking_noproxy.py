...
short_description: Sets servers for which no proxy configuration should be applied.
  This operation sets environment variables. In order for this operation to take effect,
...
RETURN = r"""
# content generated by the update_return_section callback# task: Set HTTP noproxy configuration (again)
value:
  description: Set HTTP noproxy configuration (again)
  returned: On success
  sample:
  - redhat.com
  - ansible.com
