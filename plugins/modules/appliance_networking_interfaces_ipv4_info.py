...
short_description: Retrieve the IPv4 configuration of a vCenter Server Appliance network interface.
description:
  - Gather the current IPv4 settings of a specific network interface on the vCenter Server Appliance.
  - The returned information includes the address assignment mode, the IPv4 address, the CIDR prefix,
...
EXAMPLES = r"""
- name: Get the IPv4 configuration of nic0
...
id:
  ...
  type: str
value:
  description: The IPv4 configuration of the network interface.
  returned: On success
  sample:
