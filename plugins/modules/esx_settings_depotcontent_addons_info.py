...
DOCUMENTATION = """
module: esx_settings_depotcontent_addons_info
short_description: Handle resource of type esx_settings_depotcontent_addons
description: Handle resource of type esx_settings_depotcontent_addons
options:
  min_version:
    description:
...
IN_QUERY_PARAMETER = ["min_version", "names", "vendors", "versions"]
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/api/esx/settings/depot-content/add-ons".format(
        **params
    ) + gen_args(
