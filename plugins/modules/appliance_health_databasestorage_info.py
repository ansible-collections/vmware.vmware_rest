...
short_description: Handle resource of type appliance_health_databasestorage_info
description: Handle resource of type appliance_health_databasestorage_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return (
        "https://{vcenter_hostname}" "/rest/appliance/health/database-storage"
    ).format(**params)
