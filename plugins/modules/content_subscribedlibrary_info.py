...
short_description: Handle resource of type content_subscribedlibrary_info
description: Handle resource of type content_subscribedlibrary_info
options:
  library_id:
    description:
...
async def main():
    required_if = list([["state", "get", ["library_id"], True],])
