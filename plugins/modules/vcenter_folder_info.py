...
RETURN = """
# content generated by the update_return_section callback# task: Build a list of the folders, with a filter
value:
  description: Build a list of the folders, with a filter
  returned: On success
  sample:
  - folder: group-s1359
    name: datastore
