...
short_description: Handle resource of type appliance_system_version_info
description: Handle resource of type appliance_system_version_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/system/version").format(
        **params
    )
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/system/version").format(
        **params
