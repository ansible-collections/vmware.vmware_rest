...
DOCUMENTATION = r"""
module: appliance_recovery_backup_schedules_info
short_description: Handle resource of type appliance_recovery_backup_schedules_info
description: Handle resource of type appliance_recovery_backup_schedules_info
options:
  schedule:
    description:
    - Identifier of the schedule Required with I(state=['get'])
    type: str
  vcenter_hostname:
    description:
...
async def main():
    required_if = list([["state", "get", ["schedule"], True],])
...
async def entry_point(module, session):
    ...
    async with session.get(url) as resp:
        ...
        if module.params.get("schedule"):
            _json["id"] = module.params.get("schedule")
            ...
            try:
                if (
                    isinstance(_json["value"][0]["schedule"], str)
