...
DOCUMENTATION = """
module: vcenter_vmtemplate_libraryitems_checkouts_info
...
options:
  ...
  vm:
    description:
    - Identifier of the checked out virtual machine. Required with I(state=['get'])
    type: str
author:
- Ansible VMware team
version_added: 1.0.0
...
def url(params):
    ...
    if params["vm"]:
        return "https://{vcenter_hostname}/rest/vcenter/vm-template/library-items/{template_library_item}/check-outs/{vm}".format(
            **params
        ) + gen_args(
