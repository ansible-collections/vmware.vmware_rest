...
DOCUMENTATION = r"""
module: appliance_recovery_backup_parts_info
short_description: Handle resource of type appliance_recovery_backup_parts_info
description: Handle resource of type appliance_recovery_backup_parts_info
options:
  id:
    description:
    - Identifier of the part. Required with I(state=['get'])
    type: str
  vcenter_hostname:
    description:
...
def build_url(params):
    if params.get("id"):
        ...
        return (
            (
                "https://{vcenter_hostname}" "/rest/appliance/recovery/backup/parts/"
            ).format(**params)
            + params["id"]
