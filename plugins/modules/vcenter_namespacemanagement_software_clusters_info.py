...
DOCUMENTATION = """
module: vcenter_namespacemanagement_software_clusters_info
...
def url(params):
    ...
    if params["cluster"]:
        return "https://{vcenter_hostname}/rest/api/vcenter/namespace-management/software/clusters/{cluster}".format(
            **params
        ) + gen_args(
