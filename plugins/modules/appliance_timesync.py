...
short_description: Handle resource of type appliance_timesync
description: Handle resource of type appliance_timesync
options:
  mode:
    choices:
    - DISABLED
...
async def main():
    required_if = list([["state", "set", ["mode"], True],])
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/timesync").format(**params)
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/rest/appliance/timesync")
    if subdevice_type and not params[subdevice_type]:
        _json = await exists(params, session, build_url(params))
        if _json:
            params[subdevice_type] = _json["id"]
    _url = ("https://{vcenter_hostname}" "/rest/appliance/timesync").format(
        **params
