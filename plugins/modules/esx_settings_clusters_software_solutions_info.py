...
DOCUMENTATION = """
module: esx_settings_clusters_software_solutions_info
...
options:
  ...
  solution:
    description:
    - Identifier of the solution. Required with I(state=['get'])
    type: str
author:
- Ansible VMware team
version_added: 1.0.0
...
def prepare_argument_spec():
    ...
    argument_spec["solution"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    ...
    if params["solution"]:
        return "https://{vcenter_hostname}/rest/api/esx/settings/clusters/{cluster}/software/solutions/{solution}".format(
            **params
        ) + gen_args(
