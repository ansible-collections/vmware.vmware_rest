...
options:
  ...
  used_by_name:
    description:
    - The name of the entity to list applied categories, whose type is specified in
      used_by_type.
  ...
  used_by_type:
    ...
    - vm
    description:
    - The type of the entity to list applied categories, whose name is specified in
      used_by_name.
    - Exclusive of other used_by_id and category_*.
    type: str
requirements:
