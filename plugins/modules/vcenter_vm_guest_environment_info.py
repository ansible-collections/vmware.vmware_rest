...
options:
  ...
  name:
    description:
    - The name of the environment variable to be read. Required with I(state=['get'])
    type: str
  names:
    aliases:
    - filter_names
    description:
    - The names of the variables to be read. If the {@term set} is empty, then all
      the environment variables are returned. Required with I(state=['list'])
    elements: str
    type: list
  vcenter_hostname:
    description:
...
PAYLOAD_FORMAT = {
    "get": {
        ...
        "path": {"name": "name", "vm": "vm"},
    },
    "list": {
        "query": {},
        "body": {"credentials": "credentials", "names": "names"},
        "path": {"vm": "vm"},
    },
