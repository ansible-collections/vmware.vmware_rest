...
description:
  - Returns virtual hardware version and upgrade settings for a virtual machine.
author:
...
EXAMPLES = r"""
- name: Get virtual hardware settings
...
value:
  description:
    - Virtual hardware settings for the virtual machine.
  returned: On success
  type: dict
  sample:
    version: VMX_19
