...
options:
  ...
  timeout:
    description:
    - The timeout (in seconds) specifies how long you enable the Shell access. The
      maximum timeout is 86400 seconds(1 day). This parameter is mandatory.
    required: true
    type: int
  vcenter_hostname:
    description:
...
RETURN = r"""
# content generated by the update_return_section callback# task: Enable the Shell with a timeout
value:
  description: Enable the Shell with a timeout
  returned: On success
  sample: {}
  type: dict
"""
