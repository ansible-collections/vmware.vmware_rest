...
short_description: Handle resource of type appliance_health_softwarepackages_info
description: Handle resource of type appliance_health_softwarepackages_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return (
        "https://{vcenter_hostname}" "/rest/appliance/health/software-packages"
    ).format(**params)
