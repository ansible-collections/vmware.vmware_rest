...
DOCUMENTATION = "author:\n- Ansible VMware team\ndescription: Handle resource of type esx_settings_clusters_depotoverrides\nextends_documentation_fragment: []\nmodule: esx_settings_clusters_depotoverrides\nnotes:\n- Tested on vSphere 7.0\noptions:\n  action:\n    choices:\n    - add\n    description:\n    - action=add Required with I(state=['add'])\n    type: str\n  cluster:\n    description:\n    - Identifier for the cluster.\n    type: str\n  state:\n    choices:\n    - add\n    - remove\n    description: []\n    type: str\nrequirements:\n- python >= 3.6\nshort_description: Handle resource of type esx_settings_clusters_depotoverrides\nversion_added: 1.0.0\n"
...
async def _add(params, session):
    _url = "https://{vcenter_hostname}/rest/api/esx/settings/clusters/{cluster}/depot-overrides".format(
        **params
    ) + gen_args(
...
async def _remove(params, session):
    _url = "https://{vcenter_hostname}/rest/api/esx/settings/clusters/{cluster}/depot-overrides?action=remove".format(
        **params
    ) + gen_args(
        params, IN_QUERY_PARAMETER
    )
