...
def prepare_argument_spec():
    ...
    argument_spec["vm"] = {"type": "str", "operationIds": ["get", "list"]}
    argument_spec["adapter"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    if params["adapter"]:
        return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/adapter/sata/{adapter}".format(
            **params
        ) + gen_args(
