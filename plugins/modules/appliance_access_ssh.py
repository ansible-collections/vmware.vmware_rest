...
short_description: Handle resource of type appliance_access_ssh
description: Handle resource of type appliance_access_ssh
options:
  enabled:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/access/ssh").format(**params)
...
async def _set(params, session):
    ...
    subdevice_type = get_subdevice_type("/rest/appliance/access/ssh")
    if subdevice_type and not params[subdevice_type]:
        _json = await exists(params, session, build_url(params))
        if _json:
            params[subdevice_type] = _json["id"]
    _url = ("https://{vcenter_hostname}" "/rest/appliance/access/ssh").format(
        **params
