...
DOCUMENTATION = r"""
module: appliance_update_staged_info
short_description: Handle resource of type appliance_update_staged_info
description: Handle resource of type appliance_update_staged_info
options:
  vcenter_hostname:
    description:
