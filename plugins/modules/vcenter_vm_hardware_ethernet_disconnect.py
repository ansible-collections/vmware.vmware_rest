...
DOCUMENTATION = """
module: vcenter_vm_hardware_ethernet_disconnect
short_description: Handle resource of type vcenter_vm_hardware_ethernet_disconnect
description: Handle resource of type vcenter_vm_hardware_ethernet_disconnect
options:
  nic:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["nic"] = {"type": "str", "operationIds": ["disconnect"]}
...
def url(params):
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/ethernet/{nic}/disconnect".format(
        **params
    )
