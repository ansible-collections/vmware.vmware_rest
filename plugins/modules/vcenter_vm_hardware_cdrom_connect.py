...
DOCUMENTATION = """
module: vcenter_vm_hardware_cdrom_connect
short_description: Handle resource of type vcenter_vm_hardware_cdrom_connect
description: Handle resource of type vcenter_vm_hardware_cdrom_connect
options:
  cdrom:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["cdrom"] = {"type": "str", "operationIds": ["connect"]}
...
def url(params):
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/cdrom/{cdrom}/connect".format(
        **params
    )
