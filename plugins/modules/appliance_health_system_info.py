...
short_description: Handle resource of type appliance_health_system_info
description: Handle resource of type appliance_health_system_info
options:
  vcenter_hostname:
    description:
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/rest/appliance/health/system").format(
        **params
    )
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/rest/appliance/health/system").format(
        **params
