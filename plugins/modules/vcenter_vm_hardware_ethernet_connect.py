...
DOCUMENTATION = """
module: vcenter_vm_hardware_ethernet_connect
short_description: Handle resource of type vcenter_vm_hardware_ethernet_connect
description: Handle resource of type vcenter_vm_hardware_ethernet_connect
options:
  nic:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["nic"] = {"type": "str", "operationIds": ["connect"]}
    argument_spec["state"] = {"type": "str", "choices": ["connect"]}
    argument_spec["vm"] = {"type": "str", "operationIds": ["connect"]}
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/hardware/ethernet/{nic}/connect".format(
        **params
    )
