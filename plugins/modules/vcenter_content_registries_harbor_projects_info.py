...
DOCUMENTATION = """
module: vcenter_content_registries_harbor_projects_info
...
options:
  project:
    description:
    - Identifier of the Harbor project. Required with I(state=['get'])
    type: str
  registry:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["project"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["registry"] = {"type": "str", "operationIds": ["get", "list"]}
...
def url(params):
    ...
    if params["project"]:
        return "https://{vcenter_hostname}/rest/vcenter/content/registries/harbor/{registry}/projects/{project}".format(
            **params
        ) + gen_args(
