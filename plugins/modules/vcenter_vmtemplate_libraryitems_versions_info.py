...
DOCUMENTATION = """
module: vcenter_vmtemplate_libraryitems_versions_info
...
options:
  ...
  version:
    description:
    - Version of the library item. Required with I(state=['get'])
    type: str
author:
- Ansible VMware team
version_added: 1.0.0
...
def url(params):
    ...
    if params["version"]:
        return "https://{vcenter_hostname}/rest/vcenter/vm-template/library-items/{template_library_item}/versions/{version}".format(
            **params
        ) + gen_args(
