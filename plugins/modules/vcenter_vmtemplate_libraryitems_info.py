...
def prepare_argument_spec():
    ...
    argument_spec["template_library_item"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    ...
    return "https://{vcenter_hostname}/rest/vcenter/vm-template/library-items/{template_library_item}".format(
        **params
    ) + gen_args(
