...
[vmware.vmware_rest.vcenter_host_connect](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_host_connect_module.rst)|Manage the host connect of a vCenter
[vmware.vmware_rest.vcenter_host_disconnect](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_host_disconnect_module.rst)|Manage the host disconnect of a vCenter
...
[vmware.vmware_rest.vcenter_storage_policies](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_storage_policies_module.rst)|Manage the storage policies of a vCenter
[vmware.vmware_rest.vcenter_storage_policies_compliance_vm_info](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_storage_policies_compliance_vm_info_module.rst)|Collect the information associated with the vCenter storage policies compliance vms
[vmware.vmware_rest.vcenter_storage_policies_entities_compliance_info](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_storage_policies_entities_compliance_info_module.rst)|Collect the information associated with the vCenter storage policies entities compliances
...
[vmware.vmware_rest.vcenter_storage_policies_vm_info](https://github.com/ansible-collections/vmware.vmware_rest/blob/main/docs/vmware.vmware_rest.vcenter_storage_policies_vm_info_module.rst)|Collect the information associated with the vCenter storage policies vms
