...
def test_resolve_live_resource_context_not_found_by_id(crud_module, mock_client):
    """
...
def test_resolve_live_resource_context_not_found_by_name(crud_module, mock_client):
    """
