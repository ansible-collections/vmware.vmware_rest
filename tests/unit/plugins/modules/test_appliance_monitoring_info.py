...
def test_list_monitored_items(mock_create_client, mock_ansible_module, mock_client):
    # GET /appliance/monitoring — list, 200
    ...
    mock_client.get.return_value = _response(200, MONITORING_ITEMS)
