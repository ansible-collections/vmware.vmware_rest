...
from ansible_collections.vmware.vmware_rest.plugins.module_utils._client import Response
...
def test_get_success(mock_create_client, mock_ansible_module, mock_client):
    ...
    mock_client.get.assert_called_once_with("/appliance/health/storage")
