...
SAMPLE_BODY = [{'port': '4000', 'label': 'Parallel port 1', 'state': 'NOT_CONNECTED', 'start_connected': False, 'allow_guest_control': True, 'backing': {'type': 'HOST_DEVICE'}}]
