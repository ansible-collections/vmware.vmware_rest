.. _vmware.vmware_rest.appliance_networking_dns_domains_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Domain to add. Required with <em>state=[&#x27;add&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>List of domains. Required with <em>state=[&#x27;set&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
