.. _vmware.vmware_rest.vcenter_vm_storage_policy_compliance_module:
...
**Handle resource of type vcenter_vm_storage_policy_compliance**
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>- <code>vm_home</code> (bool): Invoke compliance check on the virtual machine home directory if set to true.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
