.. _vmware.vmware_rest.folder_moid_lookup:


******************************
vmware.vmware_rest.folder_moid
******************************

**Look up MoID for vSphere folder objects using vCenter REST API**
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>MoID of the vSphere folder object</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">group-v1029</div>
                </td>
            </tr>
    </table>
    <br/><br/>
