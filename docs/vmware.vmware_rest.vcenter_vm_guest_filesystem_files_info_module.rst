.. _vmware.vmware_rest.vcenter_vm_guest_filesystem_files_info_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The complete path to the directory or file to query. This parameter is mandatory.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
