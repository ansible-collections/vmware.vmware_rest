.. _vmware.vmware_rest.appliance_networking_noproxy_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>List of strings representing servers to bypass proxy. A server can be a FQDN, IP address, FQDN:port or IP:port combinations. This parameter is mandatory.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
