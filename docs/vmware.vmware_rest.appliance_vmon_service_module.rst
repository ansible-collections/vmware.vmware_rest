.. _vmware.vmware_rest.appliance_vmon_service_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The <em>startup_type</em> enumerated type defines valid Startup Type for services managed by vMon.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">vpxd</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
