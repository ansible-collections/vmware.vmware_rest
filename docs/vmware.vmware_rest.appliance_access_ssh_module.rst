.. _vmware.vmware_rest.appliance_access_ssh_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>SSH-based controlled CLI is enabled. This parameter is mandatory.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>On success</td>
                <td>
                            <div>Ensure the SSH access ie enabled</div>
                    <br/>
