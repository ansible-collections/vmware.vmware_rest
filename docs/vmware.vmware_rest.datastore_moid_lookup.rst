.. _vmware.vmware_rest.datastore_moid_lookup:
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>MoID of the vSphere datastore object</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">datastore-1019</div>
                </td>
            </tr>
    </table>
    <br/><br/>
