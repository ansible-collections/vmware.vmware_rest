.. _vmware.vmware_rest.datacenter_moid_lookup:


**********************************
vmware.vmware_rest.datacenter_moid
**********************************

**Look up MoID for vSphere datacenter objects using vCenter REST API**
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>MoID of the vSphere datacenter object</div>
                    <br/>
