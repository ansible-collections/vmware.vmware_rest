.. _vmware.vmware_rest.cluster_moid_lookup:


*******************************
vmware.vmware_rest.cluster_moid
*******************************

**Look up MoID for vSphere cluster objects using vCenter REST API**
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td></td>
                <td>
                            <div>MoID of the vSphere cluster object</div>
                    <br/>
