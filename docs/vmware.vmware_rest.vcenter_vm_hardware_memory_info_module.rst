    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>On success</td>
                <td>
                            <div>Retrieve the memory information from the VM</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;hot_add_enabled&#x27;: 1, &#x27;size_MiB&#x27;: 1024}</div>
                </td>
            </tr>
    </table>
    <br/><br/>
