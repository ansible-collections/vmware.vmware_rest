.. _vmware.vmware_rest.vcenter_vm_tools_installer_info_module:
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>On success</td>
                <td>
                            <div>Get information about the vm-tools</div>
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;is_connected&#x27;: 0}</div>
                </td>
            </tr>
    </table>
    <br/><br/>
