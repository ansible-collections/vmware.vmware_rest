.. _vmware.vmware_rest.appliance_networking_dns_servers_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>DNS server. Required with <em>state=[&#x27;add&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>List of the currently used DNS servers. Required with <em>state=[&#x27;set&#x27;, &#x27;test&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
