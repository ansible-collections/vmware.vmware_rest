.. _vmware.vmware_rest.vcenter_vm_guest_filesystem_files_module:
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>- permissions (string): The file permissions in chmod(2) format. This field is interpreted as octal.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The complete path to the new file. It cannot be a path to an existing directory. Required with <em>state=[&#x27;move&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>If true, the destination file is overwritten.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The complete path to the directory in which to create the file.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The complete path to the file or directory to be changed in the guest.  If the file points to an symbolic link, then the attributes of the target file are changed. Required with <em>state=[&#x27;absent&#x27;, &#x27;move&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The prefix to be given to the new temporary file. Required with <em>state=[&#x27;create_temporary&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The suffix to be given to the new temporary file. Required with <em>state=[&#x27;create_temporary&#x27;]</em></div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
